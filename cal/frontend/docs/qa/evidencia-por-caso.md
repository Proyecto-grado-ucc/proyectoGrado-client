...
| CAL-QA-014 | Captura login exitoso administrador | `docs/qa/evidencias/login-exitoso-admin.png`, `docs/qa/evidencias/login-form-desktop.png` | Aprobada |
| CAL-QA-015 | Captura periodo creado + periodo visible en dashboard | `docs/qa/evidencias/periodo-creado-configuracion.png`, `docs/qa/evidencias/periodo-visible-dashboard.png`, `docs/qa/evidencias/periodo-formulario-creacion.png` | Aprobada |
...
| CAL-QA-017 | Captura compatibilidad escritorio | `docs/qa/evidencias/login-form-desktop.png`, `docs/qa/evidencias/login-exitoso-admin.png` | Aprobada |
| CAL-QA-018 | Sin captura movil por decision del equipo | Evidencia visual removida | Pendiente |
| CAL-QA-019 | Captura validacion de formulario | `docs/qa/evidencias/login-validacion-error.png`, `docs/qa/evidencias/login-form-desktop.png` | Aprobada |
